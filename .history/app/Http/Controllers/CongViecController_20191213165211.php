...
class CongViecController extends Controller
{
    ...
    {
        $baocao = DB::select("SELECT BAOCAO.*, ND.display_name  FROM TB_BAOCAO_CV BAOCAO, TB_NGUOI_DUNG ND ORDER BY BAOCAO.created_at DESC WHERE  BAOCAO.id_nd = ND.id_nd AND BAOCAO.id_cv = $id ");
