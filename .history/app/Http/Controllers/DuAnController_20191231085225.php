...
class DuAnController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->has('api_token'))
        {
            ...
            $du_an = DB::SELECT("SELECT DA.id_du_an,, DA.ten_du_an, DA.mo_ta_du_an, DA.ghi_chu_du_an, DA.trang_thai_du_an, DA.created_at, DA.updated_at,
            DA.id_loai_da, DA.id_ql, DA.DISPLAY_NAME
