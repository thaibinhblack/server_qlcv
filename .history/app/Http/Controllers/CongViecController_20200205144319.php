...
class CongViecController extends Controller
{
    ...
    public function test()
    {
        ...
        $stmt = $pdo->prepare("begin SELECT_CONG_VIEC( :P_TIME_START, :P_TIME_END); end;");
        $stmt->bindParam(':P_CUR', $result, 'PDO::FETCH_OBJ');
        $stmt->bindParam(':P_TIME_START', $p1);
        $stmt->bindParam(':P_TIME_END', $p2);
        $stmt->execute();
        return '123';
    }
}
