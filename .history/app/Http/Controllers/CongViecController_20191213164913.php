...
class CongViecController extends Controller
{
    ...
    {
        $baocao = DB::select("SELECT BAOCAO.*, ND.display_name  FROM TB_BAOCAO_CV BAOCAO, TB_NGUOI_DUNG ND WHERE  BAOCAO.id_nd = ND.id_nd where BAOCAO.id_cv = $id orderBy CREATED_AT DESC");
