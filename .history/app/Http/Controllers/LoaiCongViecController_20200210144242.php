...
{
    public function CallFunction($ID_LOAI_CV, $TEN_LOAI_CV, $TRANG_THAI, $P_MO_TA, $P_ACTION, $P_PARENT, $P_COLOR)
    {
        $sql = "DECLARE
            ...
            P_COLOR VARCHAR2(10);
        BEGIN
            :result := THEM_CAPNHAT_LOAI_CV(:P_ID_LOAI_CV,:P_TEN_LOAI_CV,:P_TRANG_THAI, :P_MO_TA, :P_ACTION, :P_PARENT, :P_COLOR);
        END;";
    ...
    public function index(Request $request)
    {
        if($request->has('api_token'))
        {
            ...
            $loai_cv = DB::SELECT("SELECT lcv.id_loai_cv, lcv.ten_loai_cv, lcv_parent.ten_loai_cv as ten_cv_cha FROM TB_LOAI_CV lcv
