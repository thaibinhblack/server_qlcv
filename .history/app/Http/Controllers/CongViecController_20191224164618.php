...
class CongViecController extends Controller
{
    ...
    {
        $cong_viec = DB::select("SELECT cv.*, nv_giao.display_name as nv_giao , nv_nhan.display_name as nv_nhan from TB_CONG_VIEC_DA cv left join tb_nguoi_dung nv_giao on cv.nguoi_giao_viec = nv_giao.id_nd 
        left join tb_nguoi_dung nv_nhan on cv.nguoi_nhan_viec = nv_nhan.id_nd where cv.cv_goc = $id");
