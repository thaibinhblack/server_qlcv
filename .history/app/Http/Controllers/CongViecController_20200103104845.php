...
class CongViecController extends Controller
{
    ...
    public function filter(Request $request)
    {
        ...
        $sql_id_loai_cv  = " AND DA_KH.id_loai_cv is not null";
        if($request->get('id_loai_cv') != '-1' && $request->has('id_loai_cv') )
        {
            $id_du_an_kh = $request->get('id_loai_cv');
            $sql_id_du_an_kh = " AND CV.id_loai_cv = $id_du_an_kh";
        }
        ...
        $sql .= $sql_id_du_an .= $sql_id_du_an_kh .= $sql_id_nhan_vien;
