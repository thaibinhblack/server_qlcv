...
class CongViecController extends Controller
{
    ...
    public function cvchuaphancong(Request $request)
    {
        ...
        {
            //check user
            $cong_viec = DB::select("SELECT CV.*, DA_KH.TEN_DU_AN_KH FROM TB_CONG_VIEC_DA CV,  TB_DU_AN_KH DA_KH
            WHERE CV.ID_CV_DA = CV_KH.ID_CV_DA AND CV.nguoi_nhan_viec is null");
            return response()->json($cong_viec, 200);
        }
    }
