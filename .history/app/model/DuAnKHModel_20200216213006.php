...
class DuAnKHModel extends Model
{
    ...
    public function THEM_UPDATE_DU_AN_KH($arr_params){
        $sql = "DECLARE
            ...
            P_ACTION NUMBER(1);
        BEGIN
            :n := THEM_UPDATE_DU_AN_KH(:P_ID_DU_AN_KH, :P_ID_DU_AN, :P_TEN_DU_AN_KH, :P_MO_TA_DU_AN, :P_GHI_CHU_DU_AN,:P_TRANG_THAI_DU_AN, :P_ID_KHACH_HANG, :P_ACTION, :P_TRANG_THAI_LT);
        END;";  
        $pdo = DB::getPdo();
